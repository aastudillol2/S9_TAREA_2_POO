...
videos = ["1) ejercicio 1'", "2) ejercicio 2", "3) ejercicio 3",
          ...
          "35) ejercicio 35", "36) ejercicio 36", "37) ejercicio 37"]
opcion = ""
while opcion !=38:
    os.system("cls")
    opcion = sub.menu(videos, "Menú de Ejercicios (VIDEOS)")
    os.system("cls")
    ...
    if opcion == "1":
        ...
        print("NUMEROS OPERACIONES EN PYTHON")
        entero = 23
        decimal = 31.78
        complejo = 12 + 5j
        # Booleano= True
        ...
        print("FUNCIONES DE CADENA EN PYTHON")
        texto = "Bienvenidos a mi tarea 2 Semana 14 "
        print(texto)
        print(texto.lower())
        print(texto.upper())
        print(texto.title())
        ...
        tupla = (1, 2, 3)
        print(tupla)
        tupla2 = (7, "Allisson,true 4,50.1, 16+ 7j ,15,""Felicidad,false")
        print(tupla)
        tupla3 = (9, 3, 4, 5, 6)
        print(tupla)
        print(tupla2[1])
        ...
        lista1 = ["Allisson", 25, 98.3, True, "Astudillo", 56.3]
        print(lista1)
        print(lista1[:])
        print(lista1[2])
        print(lista1[-1])
        ...
        lista1.append("AllissonBriana")
        print(lista1)

        lista1.insert(4, "Peru")
        print(lista1)

        lista1.extend(["Paulette", 110, False])
        print(lista1)

        print(lista1.index("Paulette"))
        ...
        lista2 = ["Milagro", "Ambato"]
        lista3 = lista1 + lista2
        print(lista3)

        print(lista2 * 4)

        print("AllissonBriana" in lista1)
        ...
        dic2 = {"Allisson": "Lopez", 25: True, "Sueldo": 150.80}
        print(dic2[25])
        ...
        datosPersonales = {"Ape": "Astudillo", "Anios": {1: 2010, 2: 2011, 3: 2012, 4: 2013, 5: 2014}}
        print(datosPersonales)
        print(datosPersonales["Anios"])

        print(datosPersonales.get('Apel', "Allisson"))
        ...
        print("LECTURA DE DATOS POR TECLADO EN PYTHON")
        ...
        print("ESTRUCTURA CONDICIONAL EN PYTHON")
        edad = int(input("Ingrese su edad:"))
        if edad >= 18:
        ...
        print("OPERADOR TERNARIO EN PYTHON")
        sexos = ("Hombre","Mujer")
        ...
        for nom in["Allissob","Briana","Astudillo","Lopez"]:
            print("Cantidad de letras de {} es: {}".format(nom,len(nom)))
        time.sleep(10)
        os.system("cls")
    
    elif opcion == "17":
        print("IF CON TUPLAS Y LISTAS EN PYTHON")
        print("***** Curso *****")
        ...
        print("FACTORIAL DE UN NUMERO EN PYTHON")
        ...
        print("GENERADORES PARTE 1 EN PYTHON")
        """
        ...
        print("GENERADORES PARTE 2 EN PYTHON")
        ...
        print("SENTENCIA RAISE EN PYTHON")
        ...
        persona1.despertar()
        persona2 = Persona()
        persona2.apellidos = "Allisson Astudillo"
        print(persona2.apellidos)
        time.sleep(10)

    elif opcion == "27":
        print("CONSTRUCTORES DE CLASE EN PYTHON")
        class Curso():
        ...
        print("Encapsulamiento de variables EN PYTHON")
        class Curso():
        ...
        print("ENCAPSULAMIENTO DE METODOS EN PYTHON")
        class Curso():
        ...
        print("METODOS ACCESORES GET AND SET EN PYTHON")
        class Cuenta():
        ...
        cuenta1 = Cuenta("Allisson Astudillo", 15000, "Soles")
        ...
        print("METODOS DE CLASE EN PYTHON")
        class Curso():
        ...
        print("SOBREESCRITURA DE METODOS EN PYTHON")
        class Persona():
            def __init__(self,apePat,apeMat,nom):
                self.apellidoPaterno = apePat
                self.nomrbreMaterno = apeMat
        ...
        estu = Estudiante("Allisson","Briana","Astudillo","Ingeniero software")
        estu.datos()
        time.sleep(3)

    elif opcion == "34":
        print("PRINCIPIO DE SUSTITUCION EN PYTHON")
        class Persona():
            def __init__(self,apePat,apeMat,nom):
                self.apellidoPaterno = apePat
                self.nomrbreMaterno = apeMat
        ...
        print("RELACIONES ENTRE CLASES EN PYTHON")
        class Pais():
        ...
        pais1 = Pais("Ecuador", "Allisson Astudillo")
        print(pais1)

        ciudad1 = Ciudad("Ambato", 150000, pais1)
        print(ciudad1)

        urba1 = Urbanizacion("Las Piñas", ciudad1)
        print(urba1)
        time.sleep(10)